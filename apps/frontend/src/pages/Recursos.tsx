...
import { sermoesService, aulasEbdService, eventosService } from "@/lib/api";
import { Sermao, AulaEbd, Evento, EbdClasse } from "shared";
...
const Recursos = () => {
  ...
  const [aulaClasse, setAulaClasse] = useState<EbdClasse | null>(null);
              ...
              <>
                          ...
                          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                            <div className="flex-1">
                              ...
                              <p className="text-muted-foreground mt-1">
                                {sermao.pregador} {sermao.textoBase && `• ${sermao.textoBase}`}
                              </p>
                              {sermao.resumo && (
                ...
                <TabsContent value="ebd" className="space-y-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <button
                      onClick={() => setAulaClasse(EbdClasse.HOMENS)}
                      className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${
                        aulaClasse === EbdClasse.HOMENS 
                    ...
                    <button
                      onClick={() => setAulaClasse(EbdClasse.BELAS)}
                      className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${
                        aulaClasse === EbdClasse.BELAS 
                    ...
                    <button
                      onClick={() => setAulaClasse(EbdClasse.ADOLESCENTES)}
                      className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${
                        aulaClasse === EbdClasse.ADOLESCENTES 

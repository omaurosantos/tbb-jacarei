            ...
            {loading ? (
              ...
              <>
                ...
                <TabsContent value="sermoes" className="space-y-4">
                  {sermoes.length === 0 ? (
                    <p className="text-center text-muted-foreground py-8">Nenhum sermão disponível no momento.</p>
                  ) : (
                    sermoes.map((sermao) => (
                ...
                <TabsContent value="ebd" className="space-y-4">
                  {aulas.length === 0 ? (
                    <p className="text-center text-muted-foreground py-8">Nenhuma aula disponível no momento.</p>
                  ) : (
                    aulas.map((aula) => (
